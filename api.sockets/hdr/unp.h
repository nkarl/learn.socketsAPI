...
/* If anything changes in the following list of #includes, must change acsite.m4
 * also, for configure’s tests. */
...
#deinf INET_ADDRSTRLEN 46 /* "ddd.ddd.ddd.ddd\0" \
                               1234567890123456 */
#endif
...
#define __SS_PAD1SIZE
    (__SS_ALIGNSIZE - sizeof(sa_family_t))
#endif
